      ...
      () => Scaffold(
        body: ListView(
          children: [
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppColor.blackColor, width: 1.2),
                  ),
                  child: profileSettingPageController.image.value.isEmpty
                      ? CircleAvatar(
                          radius: 70,
                ...
                AppText(
                  text: profileSettingPageController.nameController.text.isEmpty
                      ? "Name"
                ...
                AppText(
                  text:
                      profileSettingPageController.emailController.text.isEmpty
                          ? "Email Id"
            ...
            listiles(
                "Profile setting ",
                "Edit/update your profile detail & more",
                Icons.settings,
            ...
            controller.sharedPref.userToken.value.isEmpty
                ? SizedBox()
                : listiles("Logout", "logout", Icons.logout,
